...
**Type the code that would extract the _first_ three characters from each element of the following vector:**
...
**Type the code that would extract the _last_ three characters from each element of the following vector:**
