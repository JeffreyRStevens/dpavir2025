...
library(tidyverse)
nrows <- 12
data2 <- data.frame(id = rep(1:4, each = 3), condition = paste0("cond", rep(1:3, times = 4)), response = runif(nrows)
)
data1 <- data2 |> 
...
[Pivoting data](../code/15_pivoting.html){target="_blank"} [[Rmd](../code/15_pivoting.Rmd){target="_blank"}]
