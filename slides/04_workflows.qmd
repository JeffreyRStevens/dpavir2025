...
![](../images/rstudio_file_manager.png){.absolute width="70%" top="25%" left="30%"}
...
![](../images/terminal.png){.absolute width="80%" top="50%" left="10%"}
...
:::{.incremental}
* To move from `dpavir_2023/` to `rsconnect/`, type <br> `cd exercises/01_introduction/rsconnect/`
:::
...
* View your working directory
  ...
  * RStudio: top of Console
  ...
  ![](../images/working_directory.png){.absolute width="70%" top="25%" left="55%"}
:::
...
![](../images/here_allisonhorst.png){.absolute width="53%" top="25%" left="70%"}
