...
![](../images/coding_audience.png){fig-align="right"}
:::
...
![](../images/dates_meme.jpeg){fig-align="right"}
...
[Coding basics](../code/03_coding.html){target="_blank"} [[Rmd file](../code/03_coding.Rmd){target="_blank"}]
