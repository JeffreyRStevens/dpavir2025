...
2. Rename the column names to `"breed", "affectionate", "children", "other_dogs", "shedding", "grooming", "coat_type", "coat_length"`.
```{r}
colnames(traits) <- c("breed", "affectionate", "children", "other_dogs", "shedding", "grooming", "coat_type", "coat_length")
```

3. Do the following using `traits`. 
...
4. Do the following using `traits2`. 
